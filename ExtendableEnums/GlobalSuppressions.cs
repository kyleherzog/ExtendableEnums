...
[assembly: System.Diagnostics.CodeAnalysis.SuppressMessage("Major Code Smell", "S2743:Static fields should not be used in generic types", Justification = "Aware that this will be static to specific generic types and this is what is desired.", Scope = "member", Target = "~P:ExtendableEnums.ExtendableEnumBase`2.DeclaringTypes")]